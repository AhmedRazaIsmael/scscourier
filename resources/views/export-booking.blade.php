...
@section('title', isset($booking) ? 'Edit Export Booking' : 'Export Booking')
...
<div class="app-container">
    ...
    <div class="app-hero-header d-flex align-items-center">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="mb-1">{{ isset($booking) ? 'Edit Export Booking' : 'Export Booking' }}</h2>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-12">
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title">{{ isset($booking) ? 'Edit Export Booking' : 'Export Booking Form' }}</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ isset($booking) ? route('booking.update', $booking->id) : route('booking.store') }}">
                            ...
                            <input type="hidden" name="bookingType" value="export">
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    customerSelect?.addEventListener('change', function () {
        ...
        if(customersData[customerId]){
            ...
            // Consignee auto-fill (optional, same logic)
