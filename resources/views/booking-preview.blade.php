        ...
        <div class="left">
            ...
            <div class="box">
                ...
                <table style="margin-left:3px;">
                    <tr><td>Name:</td><td><input type="text" value="{{ $booking->shipperName ?? '-' }}" style="margin-left:-2px; width:510px"></td></tr>
                      ...
                      <td>
                        <table style="width:100%; border-collapse:collapse;">
                          <tr>
                            ...
                            <td><input type="text" value="{{ $booking->customer->contact_person_1 ?? $booking->customer->contact_person_2 ?? '-' }}" style="width:200px;"></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                    ...
                    <td>Address:</td>
                    <td>
                      <textarea class="input-address" style="width:510px;">{{ $booking->shipperAddress ?? '-' }}</textarea>
                    </td>
                </table>
            </div>
            ...
            <div class="box">
                ...
                <table style="margin-left:3px;">
                    <tr><td>Name:</td><td><input type="text" value="{{ $booking->consigneeName ?? '-' }}" style="margin-left:-2px; width:510px"></td></tr>
                  ...
                  <td>
                   ...
                   <td>Address:</td>
                    <td>
                      <textarea class="input-address" style="width:510px;">{{ $booking->consigneeAddress ?? '-' }}</textarea>
                    </td>
                </table>
            </div>
        </div>
