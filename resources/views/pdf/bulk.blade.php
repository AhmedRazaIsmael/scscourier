...
@php
    // Approximate height of each box, adjust as per your content/CSS
    $bookingBoxHeight = 198;   // Booking Details
    $shipperBoxHeight = 198;   // Shipper Details
    $consigneeBoxHeight = 150; // Consignee Details
    $leftHeight = $bookingBoxHeight + $shipperBoxHeight + $consigneeBoxHeight;
@endphp
...
<div class="page" @if($loop->last) style="page-break-after:auto;" @endif>
    ...
    <!-- Tracking Number -->
    <div style="text-align:left; font-weight:bold; font-size:14px; margin:-50px 100px 20px 250px;">
    ...
    <div class="main">
        <div class="left">
            ...
            <div class="box">
                ...
                <table style="margin-left:3px;">
                    <tr><td>Name:</td><td><input type="text" value="{{ $booking->shipperCompany ?? '-' }}" style="margin-left:-2px; width:510px;"></td></tr>
                    <tr><td>Email:</td><td><input type="text" value="{{ $booking->shipperEmail ?? '-' }}" style="margin-left:-2px; width:510px;"></td></tr>
                    <tr>
                        <td>Contact No.:</td>
                        <td>
                            <table style="width:100%; border-collapse:collapse;">
                                <tr>
                                    ...
                                    <td><input type="text" value="{{ $booking->shipperName ?? '-' }}" style="width:200px;"></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        <td>Address:</td>
                        <td><textarea class="input-address" style="width:515px;">{{ $booking->shipperAddress ?? '-' }}</textarea></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="box">
                ...
                <table style="margin-left:3px;">
                    ...
                    <tr>
                        <td>Address:</td>
                        <td><textarea class="input-address" style="width:515px;">{{ $booking->consigneeAddress ?? '-' }}</textarea></td>
                    </tr>
                </table>
            </div>
        ...
        <div class="barcode-section">
            <div class="barcode-box" style="height: 57.8%;">
                <div class="barcode">
                    {!! DNS1D::getBarcodeHTML($booking->bookNo, 'C128', 2, 70) !!}
                    <div class="barcode-number">{{ $booking->bookNo }}</div>
                </div>

                <div class="qrcode" style="margin-top:280px; margin-left:10px;">
